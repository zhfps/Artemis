...
class Config {
  ...
  /** 图标路径 */
  private static readonly LOGO_PATH =  this.IS_DEV_MODE ? NodePath.resolve(this.DIR_APP,  'public/favicon.ico') : NodePath.resolve(this.DIR_APP, NodePath.join('dist', 'favicon.ico'))
  /** 客户端图标 APP_LOGO */
